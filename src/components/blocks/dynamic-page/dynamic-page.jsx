        ...
        return (
          <StyledHeroSection key={index} id={blockId}>
            <div className="case-container">
              ...
              <h2 className="container-title">{section.subtitle}</h2>
              <h2 className="container-title for-mobile">{section.title}</h2>
  ...
  return (
    <StyledCase1>
      <div className="link-container">
        ...
        <Link className="cases-link active" href={`/${pageData.slug}`}>\&nbsp;{pageData.title}</Link>
      </div>
      <div className="case-wrapper">
        <h1 className="case-title">{pageData.title}</h1>
